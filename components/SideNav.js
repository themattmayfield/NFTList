    ...
    <>
      <Transition.Root show={sidebarOpen} as={Fragment}>
        ...
        >
          ...
          >
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-black">
              <Transition.Child
                as={Fragment}
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 dark:border-nftGray lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-gray-100 dark:bg-black">
